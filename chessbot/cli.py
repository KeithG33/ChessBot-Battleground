...
from chessbot.train.config import load_default_config
...
def find_and_load_from_register(model_name, model_dir, model_args, model_kwargs):
    ...
    ModelRegistry.load_models_from_directory(model_dir)

    try:
        # Pass both positional and keyword arguments to load_model
        model = ModelRegistry.load_model(model_name, *model_args, **extra_kwargs)
