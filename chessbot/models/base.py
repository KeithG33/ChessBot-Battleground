...
class BaseModel(nn.Module):
    ...
    action logits and board value as outputs.
    """
    def __init__(self):
        super().__init__()
    ...
    def forward(self, x):
        ...
        Note that modifying inputs and outputs may require configuration of the trainer.
        ...
        Returns:
            ...
            action_logits should have the shape (B, self.action_dim) and board_val should have shape (B,).
        """
